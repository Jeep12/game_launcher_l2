...
class TimerManager {
  ...
  updateProgress(operationId, progress, currentSize = 0, downloadedBytes = 0) {
    ...
    // Calcular velocidad real basada en bytes descargados
    if (elapsed > 1000 && downloadedBytes > 0) { // Solo calcular después de 1 segundo
